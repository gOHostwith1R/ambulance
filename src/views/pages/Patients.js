...
import {getPatients} from "../../models/models.patients.js";
import {getDoctor} from "../../models/models.doctor.js";
import {STATUS_PATIENT} from "../../utils/constants.js";

export default class Patients extends AbstractView {
    constructor() {
        super();
                        ...
                        <header class="card-title">
                            ...
                            <div class="card-patient__container">
                                ...
                                <div class="card-patient__container-status">
                                    ...
                                    <p class="card-patient__describe-status">{Appointment is ${STATUS_PATIENT.confirmed}</p>
                                </div>
                            </div>
