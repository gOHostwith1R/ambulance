...
describe('Should render appointments page', () => {
  it('should render appointments ', () => {
    ...
    const statusForDoctor = 'resolved';

    render(
      <PatientsList listOfAppointments={listOfAppointments} statusForDoctor={statusForDoctor} />,
    );
  ...
  it('should render empty list ', () => {
    ...
    render(<PatientsList listOfAppointments={emptyListOfAppointments} statusForDoctor={statusForDoctor} />);
