...
const PatientsPage = () => {
  document.title = DICTIONARY.pageName.patients;
  return (
    <PageWrapper>
      <MainHeader>
        <HeaderUser>
          <UserInfo>
            ...
            <Paragraph variant="caption" textAlign="end" color="#A1ABC9">{DICTIONARY.roles.doctor}</Paragraph>
          </UserInfo>
      ...
      <MainWrapper>
        <ContentWrapper>
          ...
          <ContentHeader>
            <Title variant="h2">{DICTIONARY.pageName.myPatients}</Title>
